# tput --help
# String Capabilities
# In the following table, `(P)' following an explanation means that the capability takes one or more parameters 
# (and is evaluated by the tparam function, or in the case of `cup', tgoto); `(*)' means that padding may be based 
# on the number of lines affected; and `#n' refers to the `n'th parameter.

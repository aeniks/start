...
####
(figlet -w $COLUMNS -f Roman "$ww"|bat -ppfljava --theme DarkNeon; printf %b "\e[2A${ww[1]}\n"|bat -ppfll --theme DarkNeon ; printf %b "\n${ww[*]:2}\n"|tr "\n" " "|bat -ppf --language d --theme Visual\ Studio\ Dark+ ; printf %b "\n")|tee ~/logs/words/w_${ww}_f.log | aha -x -s -t "word of the day - $w_w" -b -y "margin:0;width:100%;overflow-x:hidden;
